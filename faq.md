...
faq:
  - question: "What is Claude Code?"
    answer: "Claude Code is Anthropic's official CLI for AI-powered coding assistance, powered by Opus 5, Sonnet 5, Fable 5, and Haiku 4.5 with a 1M token context window. It provides an interactive terminal experience where Claude reads files, writes code, runs commands, manages tasks, and coordinates agent teams. Claude Code understands your project through CLAUDE.md files and can be extended with hooks, skills, and MCP servers."
