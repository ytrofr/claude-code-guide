...
**Evidence**: Production incident — `.bashrc` free-tier key overrode billing key in server, caused hours of 429 errors
...
| GCP Secret Manager | Production/staging | `gcloud secrets` |
